...
//
//	mockgen -typed -package quic -self_package github.com/MerIijn/quic-go -self_package github.com/MerIijn/quic-go -destination mock_packetconn_test.go net PacketConn
//
