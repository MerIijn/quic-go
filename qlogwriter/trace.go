...
import (
	...
	"github.com/MerIijn/quic-go/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/MerIijn/quic-go/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/MerIijn/quic-go" {
