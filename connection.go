...
import (
	...
	"github.com/MerIijn/quic-go/internal/ackhandler"
	"github.com/MerIijn/quic-go/internal/flowcontrol"
	"github.com/MerIijn/quic-go/internal/handshake"
	"github.com/MerIijn/quic-go/internal/monotime"
	"github.com/MerIijn/quic-go/internal/protocol"
	"github.com/MerIijn/quic-go/internal/qerr"
	"github.com/MerIijn/quic-go/internal/utils"
	"github.com/MerIijn/quic-go/internal/utils/ringbuffer"
	"github.com/MerIijn/quic-go/internal/wire"
	"github.com/MerIijn/quic-go/qlog"
...
var newConnection = func(
	...
	params := &wire.TransportParameters{
		...
		// See https://github.com/MerIijn/quic-go/pull/3806.
...
var newClientConnection = func(
	...
	if s.config.ClientHelloID != nil || s.config.ClientHelloSpec != nil {
		// Pin transport parameters to Chrome 150's values; marshalChrome emits
		// them with Chrome's exact set, GREASE and google_connection_options.
		params.EmitChromeQUIC = true
		params.InitialMaxData = 15728640
		params.InitialMaxStreamDataBidiLocal = 6291456
		params.InitialMaxStreamDataBidiRemote = 6291456
		params.InitialMaxStreamDataUni = 6291456
		params.MaxIdleTimeout = 300000 * time.Millisecond
